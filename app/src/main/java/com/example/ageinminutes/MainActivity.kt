    ...
    fun clickDatePicker(view: View){
        ...
        val dpd = DatePickerDialog(this,
            DatePickerDialog.OnDateSetListener {
                ...
                //Toast.makeText(this, "Chosen year is $selectedYear, month is ${selectedMonth + 1} and day is $selectedDayOfMonth", Toast.LENGTH_LONG).show()
                ...
                binding.tvSelectedDateInMinute.text = ageInMinutes.toString()
                binding.tvAgeInHours.text = ageInHours.toString()
